...
| **L3** | Forcing metrics | Frequency-band energy decomposition, storm/event detection, transport proxies (Shields from the wave stress; Rouse from the Soulsby wave-current mean stress `tau_m`), tidal + undertow current decomposition |
