...
PUV-derived wave parameters showed strong agreement with the MOP wave
model across all four TBR23 instruments (Table~\ref{tab:validation}).
For instruments unaffected by biofouling, $H_s$ correlations exceeded
$R^2 = 0.83$ with RMSE $< \SI{0.06}{\meter}$ and biases of
\SIrange{+0.002}{+0.008}{\meter}. One instrument (MOP580 5m) exhibited
lower agreement ($R^2 = 0.66$, bias $= \SI{+0.037}{\meter}$), attributed
to intermittent kelp fouling that reduced the valid segment rate to 49\%
compared with \SIrange{85}{91}{\percent} for the remaining instruments.
A small but consistent positive $H_s$ bias was observed across all
instruments, with PUV-measured wave heights systematically exceeding
shoaled MOP values.
