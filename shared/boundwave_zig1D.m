function Z_IG = boundwave_zig1D(eta, depth, fs, opts)
% BOUNDWAVE_ZIG1D  Estimate 1D collinear forced (bound) IG timeseries.
%
%   Z_IG = boundwave_zig1D(eta, depth, fs, opts)
%
%   Returns the bound-wave IG surface-elevation timeseries forced by
%   difference-frequency interactions of swell-band pairs in `eta`,
